...
<form id="cambio-contacto"name="cambio_frm"action="php/modificar-contacto.php"method="post"enctype="multipart/form-data">
	<fieldset>
		<legend>Revición de proyectos</legend>
		<div>
			<label for="contacto-lista">Seleccione el usuario:</label>
				<center><select id="contacto-lista"class="cambio"name="contacto_slc"required>
				<option value="">----</option>
