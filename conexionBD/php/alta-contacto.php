...
<fieldset>
	...
	<div>
    	<label for="contrasena">Contraseña:</label>
       	<input type="password"id="contrasena"class="cambio"name="contrasena_txt"placeholder="Escribe tu contraseña"title="Tu contraseña" />
	</div>
	<div>
	...
	<div>
		<label for="telefono">Telefono:</label><input type="number"id="telefono"class="cambio"name="telefono_txt"placeholder="Escribe tu telefono"title="Tu telefono" required/>
	</div>
