...
<form id="cambio-contacto"name="cambio_frm"action="php/modificar-contacto.php"method="post"enctype="multipart/form-data"accept-charset="utf-8">
	<fieldset>
		<legend>Notas</legend>
		<div>
			
				<select id="oculto"><?php include("select-email.php"); ?>
				</select>
